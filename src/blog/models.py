...
class Blog(models.Model):
    STATUS_CHOICES = [("p", "publish"), ("d", "draft")]
    author = models.ForeignKey(user, default=None, null=False, blank=False, on_delete=models.CASCADE,
                               related_name="blogs", verbose_name=_("Author"))
    category = models.ManyToManyField("Category", default=None, blank=True, related_name="blogs",
                                      verbose_name=_("Categories"))
    title = models.CharField(max_length=200, verbose_name=_("Title"))
    slug = models.SlugField(unique=True, blank=True, verbose_name=_("Slug"), help_text=_("Do not fill in here"))
    ...
    likes = models.ManyToManyField(user, blank=True, related_name="blogs_like", verbose_name=_("Likes"))
...
class Category(models.Model):
    parent = models.ForeignKey("self", null=True, default=None, blank=True, on_delete=models.CASCADE,
                               related_name="children", verbose_name=_("Subcategory"))
    title = models.CharField(max_length=150, blank=False, verbose_name=_("Title"))
    slug = models.SlugField(unique=True, blank=False, verbose_name=_("Slug"), help_text=_("Do not fill in here"))
